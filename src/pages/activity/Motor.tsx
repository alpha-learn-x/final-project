...
const Motor = () => {
  ...
  useEffect(() => {
    ...
    if (currentSection === "video") {
      toast(`🤖 Hi ${userName}! I'm Robo! Let's build the most amazing motor together!`, {
        duration: 4000,
      });
    }
  ...
  const showFeedback = (isCorrect: boolean, message: string) => {
    if (isCorrect) {
      ...
      toast.success(`🎉 Great job, ${userName}! ${message}`, { duration: 3000 });
        ...
        <CardHeader>
          ...
          <div className="bg-yellow-100 p-4 rounded-lg border-2 border-yellow-400">
            <p className="text-purple-700 font-bold">
              {`"Hi ${userName}! I'm Robo the Engineer! Let's build the most amazing spinning motor together! 
          ...
          <div className="flex items-center justify-between mb-8">
            ...
            <div className="text-center">
              ...
              <div className="bg-yellow-100 p-3 rounded-lg mt-2 border-2 border-yellow-400">
                <p className="text-purple-700 font-bold">👋 Hi {userName}! Ready to spin some magic with me?</p>
              </div>
            </div>

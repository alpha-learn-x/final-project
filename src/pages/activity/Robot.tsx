          ...
          <div className="flex items-center justify-between mb-8">
            ...
            <div className="text-center">
              ...
              <p className="text-lg text-gray-700">
                Create your own robot and learn about artificial intelligence, {userName}!
              </p>
            </div>
          ...
          <Card className="mb-8">
            <CardContent className="p-6">
              ...
              <div className="flex justify-between text-sm text-gray-600">
                <span>You're building the future, {userName}! 🤖</span>
                  ...
                  <div className="flex items-center justify-between">
                    <div>
                      <p className="text-orange-700 text-lg">
                        Outstanding, {userName}! You&apos;ve earned <strong>{earnedRewards} stars</strong> ⭐
                      </p>
              ...
              <Card className="mt-8 bg-gradient-to-r from-gold-100 to-yellow-100 border-2 border-gold-300">
                <CardContent className="p-6 text-center">
                  <h3 className="text-2xl font-bold text-yellow-800 mb-4">
                    🎉 Congratulations, {userName}! Course Complete!
                  </h3>

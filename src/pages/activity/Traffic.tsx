...
import { ArrowLeft, Award, QrCode, CheckCircle } from "lucide-react";
...
const Traffic = () => {
  ...
  const [currentSection, setCurrentSection] = useState<string>("video");
          ...
          <div className="flex items-center justify-between mb-8">
            ...
            <div className="text-center">
              ...
              <p className="text-lg text-gray-700">
                Learn about automation by building a smart traffic light, {userName}!
              </p>
            </div>
          ...
          <Card className="mb-8">
            <CardContent className="p-6">
              <div className="flex items-center justify-between mb-4">
                <h3 className="text-xl font-bold text-blue-800">{userName}&apos;s Progress</h3>
              ...
              <div className="flex justify-between text-sm text-gray-600">
                <span>Great job learning about automation, {userName}! 🚦</span>
                <span>{earnedRewards} ⭐ earned by {userName}</span>
              </div>
            </CardContent>
          </Card>
                  ...
                  <div className="flex items-center justify-between">
                    <div>
                      <p className="text-orange-700 text-lg">
                        Amazing work, {userName}! You&apos;ve earned <strong>{earnedRewards} stars</strong> ⭐
                      </p>
              ...
              <Card className="mt-8 bg-gradient-to-r from-green-100 to-blue-100 border-2 border-green-300">
                <CardContent className="p-6 text-center">
                  ...
                  <p className="text-green-700 mb-4">
                    Excellent, {userName}! You&apos;ve mastered traffic light automation. Ready for the final challenge?
                  </p>

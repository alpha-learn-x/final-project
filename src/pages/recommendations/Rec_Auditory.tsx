...
const Rec_Auditory: React.FC = () => {
    const audioRef = useRef<HTMLAudioElement>(null);

    const [quizzes, setQuizzes] = useState<Rec_AuditoryQuiz[]>([]);
                ...
                <div className="text-center mb-8">
                    <div className="relative">
                        ...
                        <h1 className="text-6xl font-bold text-white mb-6 animate-pulse">
                            🎵 Test 1 - Auditory Recommendation
                        </h1>
                    </div>
                    ...
                    {!isSubmitted ? (
                        <>
                            ...
                            <h2 className="text-3xl font-semibold text-center mb-2 text-purple-800">
                                Rec_Auditory Question {currentQuestionIndex + 1}
                            </h2>

            ...
            <div className="container mx-auto px-4 py-12">
                ...
                <div className="bg-white/95 backdrop-blur-sm rounded-3xl shadow-2xl p-10 border-4 border-yellow-300 flex-1 flex flex-col items-center">
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-8 w-full max-w-5xl">
                        <Link to="/Rec_read-write" className="bg-gradient-to-r from-blue-100 to-purple-100 rounded-2xl p-6 border-2 border-dashed border-blue-300 hover:bg-blue-200 transition-all duration-300">
                        ...
                        <Link to="/Rec_visual" className="bg-gradient-to-r from-blue-100 to-purple-100 rounded-2xl p-6 border-2 border-dashed border-blue-300 hover:bg-blue-200 transition-all duration-300">
                            <div className="flex items-center justify-center">
                                <Eye className="h-12 w-12 text-purple-800 mr-4" />
                                <span className="text-2xl font-bold text-purple-800">Visual</span>
                            </div>
                        </Link>
                        <Link to="/Rec_kinesthetic" className="bg-gradient-to-r from-blue-100 to-purple-100 rounded-2xl p-6 border-2 border-dashed border-blue-300 hover:bg-blue-200 transition-all duration-300">
                            <div className="flex items-center justify-center">
                                <Target className="h-12 w-12 text-purple-800 mr-4" />
                                <span className="text-2xl font-bold text-purple-800">Kinesthetics</span>
                            </div>
                        </Link>
                        <Link to="/Rec_auditory" className="bg-gradient-to-r from-blue-100 to-purple-100 rounded-2xl p-6 border-2 border-dashed border-blue-300 hover:bg-blue-200 transition-all duration-300">
                            <div className="flex items-center justify-center">
...
export default Rec_GameContext;